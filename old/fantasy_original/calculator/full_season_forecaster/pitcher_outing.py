...
def input_last_outing_stats():
		outing_innings = float(input('How many Innings?\n                                  '))
		outing_homeruns_allowed = float(input('How Many Home Runs?\n                           '))
		outing_strikeouts = float(input('How Many Strikeouts?\n                               '))
		outing_hits_allowed = float(input('How Many Hits?\n                          '))
		outing_total_walks = float(input('How Many Walks?\n                             '))
		outing_earned_runs = float(input('How Many Earned Runs?\n                             '))
		...
		outing_saves = 0
		decision = input('Did the pitcher get a win, loss, save, or blown save?\n                             ')
