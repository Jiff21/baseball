...
TEAM_HITTING_JSON_BLOCK = '?stitch_env=prod&sportId=1&gameType=R&group=hitting&order=desc&sortStat=battingAverage&stats=season'
...
# Somewhat blingdly update to this from above
TEAM_STATS_URI = '?stitch_env=prod&sportId=1&gameType=R&group=hitting&order=desc&sortStat=onBasePlusSlugging&stats=season&season=' \
                     + YEAR_FOR_HITTING_STATS \
                     + '&limit=30&offset=0'
