...
def input_last_season_stats():
	season_innings = float(input('How many Innings Pitched Last Season?\n                                  '))
	season_starts = float(input('How many Game Starts Last Season?\n                                    '))
	season_era = float(input('What was the ERA Last Season?\n                           '))
	season_home_runs = float(input('How Many Home Runs Last Season?\n                           '))
	season_strikeouts = float(input('How Many Strikeouts Last Season?\n                               '))
	season_win_total = float(input('How Many Wins Last Season?\n                        '))
	season_loss_total = float(input('How many Losses Last Season?\n                           '))
	season_hits_allowed = float(input('How Many Hits Last Season?\n                          '))
	season_walk_total = float(input('How Many Walks last season?\n                             '))
	projected_starts = float(input('How many starts next season?\n                           '))
	projected_fip = float(input('What was the FIP\n                           '))
