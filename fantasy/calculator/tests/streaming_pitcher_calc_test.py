import unittest
from calculator.tests.stubbed_data.standings import Standings
from calculator.settings.team_record_map import return_wins_losses, get_record_map, create_teams
